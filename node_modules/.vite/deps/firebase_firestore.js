...
var Pt = class {
  constructor(t, e) {
     ...
     */
    this.R = new K2(), this.transaction.oncomplete = () => {
      this.R.resolve();
    }, this.transaction.onabort = () => {
      e.error ? this.R.reject(new St(t, e.error)) : this.R.resolve();
    }, this.transaction.onerror = (e2) => {
      const n = kt(e2.target.error);
      this.R.reject(new St(t, n));
    };
  }
  static open(t, e, n, s) {
    try {
  ...
  abort(t) {
    t && this.R.reject(t), this.aborted || (N2("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), this.aborted = true, this.transaction.abort());
  }
  P() {
  ...
  async O(t) {
    return this.db || (N2("SimpleDb", "Opening database:", this.name), this.db = await new Promise((e, n) => {
      ...
      s.onsuccess = (t2) => {
        ...
        this.V.$(e2, s.transaction, t2.oldVersion, this.version).next(() => {
  ...
  W(t, e) {
    ...
    return new vt((s, i) => {
      t.onerror = (t2) => {
        ...
        if (o instanceof vt) {
          const t3 = o.catch((t4) => (r2.done(), vt.reject(t4)));
          n.push(t3);
        }
  ...
  et(t) {
    N2("IndexBackiller", `Scheduled in ${t}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", t, async () => {
      ...
      try {
        ...
        Dt(t2) ? N2("IndexBackiller", "Ignoring IndexedDB error during index backfill: ", t2) : await Rt(t2);
      }
      await this.et(6e4);
    });
  }
...
var Ot = class {
  ...
  st(t, e) {
    ...
    let s = e, i = true;
    return vt.doWhile(() => true === i && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t).next((e2) => {
      if (null !== e2 && !n.has(e2))
...
function Gt(t) {
  ...
  for (let i = 0; i < e; ) {
    ...
    (e2 < 0 || e2 > __PRIVATE_lastReasonableEscapeIndex) && $();
...
function nn(t) {
  return "nullValue" in t ? Be : "booleanValue" in t ? {
    ...
    bytesValue: ""
  } : "referenceValue" in t ? We($e.empty(), ht.empty()) : "geoPointValue" in t ? {
    geoPointValue: {
      latitude: -90,
      longitude: -180
    }
...
function sn(t) {
  return "nullValue" in t ? {
    ...
    bytesValue: ""
  } : "bytesValue" in t ? We($e.empty(), ht.empty()) : "referenceValue" in t ? {
    geoPointValue: {
      latitude: -90,
      longitude: -180
    }
...
var Un = class {
  ...
  constructor(t, e = null, n = [], s = [], i = null, r2 = "F", o = null, u = null) {
    this.path = t, this.collectionGroup = e, this.explicitOrderBy = n, this.filters = s, this.limit = i, this.limitType = r2, this.startAt = o, this.endAt = u, this.dt = null, // The corresponding `Target` of this `Query` instance.
...
function Hn(t) {
  ...
  if (null === e.dt) {
    ...
    if (null !== t2 && null === n)
      t2.isKeyField() || e.dt.push(new dn(t2)), e.dt.push(new dn(
        at.keyField(),
        "asc"
        /* Direction.ASCENDING */
      ));
...
var ni = class {
  constructor(t, e, n) {
    this.alias = t, this.gt = e, this.fieldPath = n;
  }
};
var si = class {
  constructor(t, e) {
...
var _i = class {
  constructor(t, e, n) {
    ...
    this.yt = 8 * t.length - e, // Set the bit count in Integer to avoid repetition in mightContain().
...
var Ti = class {
  constructor() {
     ...
     */
    this.St = Ri(), /** See public getters for explanations of these fields. */
    this.Dt = Ve.EMPTY_BYTE_STRING, this.Ct = false, /**
...
var Ei = class {
  constructor(t) {
    this.Kt = t, /** The internal state of all tracked targets. */
    this.Gt = /* @__PURE__ */ new Map(), /** Keeps track of the documents to update since the last raised snapshot. */
    this.Qt = cs(), /** A mapping of document keys to their set of target IDs. */
    this.jt = Ai(), /**
    ...
    this.forEachTarget(t, (e) => {
      ...
      switch (t.state) {
        case 0:
          ...
          break;
        case 1:
          n.qt(), n.Nt || // We have a freshly added target, so we need to reset any state
  ...
  ie(t, e) {
    ...
    try {
      ...
      return M2(t2 instanceof wi ? "BloomFilter error: " : "Applying bloom filter failed: ", t2), 1;
    }
    if (0 === c.yt)
      return 1;
  ...
  Jt(t, e, n) {
    ...
    this.ce(t, e) ? s.Ft(
      ...
      s.Bt(e)
    ), this.jt = this.jt.insert(e, this.ae(e).delete(t)), n && (this.Qt = this.Qt.insert(e, n));
  }
  removeTarget(t) {
    this.Gt.delete(t);
  }
...
function Ki(t, e, n) {
  const s = $i(t, e.name), i = Ni(e.updateTime), r2 = e.createTime ? Ni(e.createTime) : rt.min(), o = new un({
    mapValue: {
      fields: e.fields
    }
...
function Gi(t, e) {
  return "found" in e ? function(t2, e2) {
    ...
    const n = $i(t2, e2.found.name), s = Ni(e2.found.updateTime), i = e2.found.createTime ? Ni(e2.found.createTime) : rt.min(), r2 = new un({
      mapValue: {
    ...
    const n = $i(t2, e2.missing), s = Ni(e2.readTime);
...
function zi(t, e) {
  const n = e.currentDocument ? function(t2) {
    ...
    if ("setToServerValue" in e3)
      ...
      "increment" in e3 ? n2 = new xs(t2, e3.increment) : $();
    const s2 = at.fromServerFormat(e3.fieldPath);
    return new Ms(s2, n2);
  }(t, e2)) : [];
  if (e.update) {
    e.update.name;
    const i = $i(t, e.update.name), r2 = new un({
      mapValue: {
    ...
    if (e.updateMask) {
      const t2 = function(t3) {
        ...
        return new ve(e2.map((t4) => at.fromServerFormat(t4)));
      }(e.updateMask);
  ...
  if (e.delete) {
    const s2 = $i(t, e.delete);
    return new Ys(s2, n);
  }
  if (e.verify) {
    const s2 = $i(t, e.verify);
    return new Xs(s2, n);
  }
  return $();
}
function Wi(t, e) {
  return t && t.length > 0 ? (F2(void 0 !== e), t.map((t2) => function(t3, e2) {
    ...
    (n = Ni(e2)), new $s(n, t3.transformResults || []);
  }(t2, e))) : [];
}
function Hi(t, e) {
  return {
...
function hr(t, e) {
  let n;
  if (e.document)
    n = Ki(t.le, e.document, !!e.hasCommittedMutations);
  else if (e.noDocument) {
    const t2 = ht.fromSegments(e.noDocument.path), s = _r(e.noDocument.readTime);
    n = an.newNoDocument(t2, s), e.hasCommittedMutations && n.setHasCommittedMutations();
  } else {
    if (!e.unknownDocument)
      return $();
    {
      const t2 = ht.fromSegments(e.unknownDocument.path), s = _r(e.unknownDocument.version);
...
function wr(t, e) {
  const n = (e.baseMutations || []).map((e2) => zi(t.le, e2));
  ...
  const s = e.mutations.map((e2) => zi(t.le, e2)), i = it.fromMillis(e.localWriteTimeMs);
  return new Zs(e.batchId, i, n, s);
}
function mr(t) {
  const e = _r(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? _r(t.lastLimboFreeSnapshotVersion) : rt.min();
  let s;
  var i;
...
function gr(t, e) {
  ...
  let i;
  i = Fn(e.target) ? Hi(t.le, e.target) : Ji(t.le, e.target);
  const r2 = e.resumeToken.toBase64();
  return {
    targetId: e.targetId,
    canonicalId: On(e.target),
    readTime: n,
    resumeToken: r2,
...
function pr(t, e) {
  return new ei(e.largestBatchId, zi(t.le, e.overlayMutation));
}
function Ir(t, e) {
...
var Er = class {
  ...
  getNamedQuery(t, e) {
    return Rr(t).get(e).next((t2) => {
      if (t2)
        return {
          name: (e2 = t2).name,
          query: yr(e2.bundledQuery),
          readTime: _r(e2.readTime)
        };
      var e2;
    });
  }
  saveNamedQuery(t, e) {
    return Rr(t).put(function(t2) {
      return {
        name: t2.name,
  ...
  de(t, e) {
    return Pr(t).put(function(t2, e2, n) {
      ...
      return {
        ...
        overlayMutation: ji(t2.le, n.mutation)
      };
...
var br = class {
  ...
  _e(t, e) {
    this.we(t, e), // Write separator to split index values
  ...
  we(t, e) {
    if ("nullValue" in t)
      ...
      this.ge(e, 10), e.ye(t.booleanValue ? 1 : 0);
    else if ("integerValue" in t)
      this.ge(e, 15), e.ye(Ce(t.integerValue));
    else if ("doubleValue" in t) {
      const n = Ce(t.doubleValue);
      isNaN(n) ? this.ge(e, 13) : (this.ge(e, 15), Bt(n) ? (
        // -0.0, 0 and 0.0 are all considered the same
        e.ye(0)
      ) : e.ye(n));
    } else if ("timestampValue" in t) {
      const n = t.timestampValue;
      this.ge(e, 20), "string" == typeof n ? e.pe(n) : (e.pe(`${n.seconds || ""}`), e.ye(n.nanos || 0));
    } else if ("stringValue" in t)
      this.Ie(t.stringValue, e), this.Te(e);
    else if ("bytesValue" in t)
      this.ge(e, 30), e.Ee(xe(t.bytesValue)), this.Te(e);
    else if ("referenceValue" in t)
      this.Ae(t.referenceValue, e);
    else if ("geoPointValue" in t) {
      const n = t.geoPointValue;
      this.ge(e, 45), e.ye(n.latitude || 0), e.ye(n.longitude || 0);
    } else
      "mapValue" in t ? en(t) ? this.ge(e, Number.MAX_SAFE_INTEGER) : (this.Re(t.mapValue, e), this.Te(e)) : "arrayValue" in t ? (this.ve(t.arrayValue, e), this.Te(e)) : $();
  }
  Ie(t, e) {
    this.ge(e, 25), this.Pe(t, e);
  }
  Pe(t, e) {
    e.pe(t);
  }
...
var Dr = class {
  ...
  ke(t) {
    for (const e of t) {
      ...
      if (t2 < 128)
        ...
        this.Se(960 | t2 >>> 6), this.Se(128 | 63 & t2);
      else if (e < "\uD800" || "\uDBFF" < e)
        this.Se(480 | t2 >>> 12), this.Se(128 | 63 & t2 >>> 6), this.Se(128 | 63 & t2);
      else {
        const t3 = e.codePointAt(0);
        this.Se(240 | t3 >>> 18), this.Se(128 | 63 & t3 >>> 12), this.Se(128 | 63 & t3 >>> 6), this.Se(128 | 63 & t3);
      }
    }
    this.De();
  }
  ...
  Me(t) {
    for (const e of t) {
      ...
      if (t2 < 128)
        ...
        this.xe(960 | t2 >>> 6), this.xe(128 | 63 & t2);
      else if (e < "\uD800" || "\uDBFF" < e)
        this.xe(480 | t2 >>> 12), this.xe(128 | 63 & t2 >>> 6), this.xe(128 | 63 & t2);
      else {
        const t3 = e.codePointAt(0);
        this.xe(240 | t3 >>> 18), this.xe(128 | 63 & t3 >>> 12), this.xe(128 | 63 & t3 >>> 6), this.xe(128 | 63 & t3);
      }
    }
    this.Ne();
  }
  Oe(t) {
    const e = this.$e(t), n = Sr(e);
    this.Fe(1 + n), this.buffer[this.position++] = 255 & n;
  ...
  seed(t) {
    this.Fe(t.length), this.buffer.set(t, this.position), this.position += t.length;
  }
  ...
  Se(t) {
    const e = 255 & t;
    0 === e ? (this.qe(0), this.qe(255)) : 255 === e ? (this.qe(255), this.qe(0)) : this.qe(e);
  }
  ...
  qe(t) {
    this.Fe(1), this.buffer[this.position++] = t;
  }
  Ke(t) {
    this.Fe(1), this.buffer[this.position++] = ~t;
  }
...
var Nr = class {
  constructor() {
    this.Qe = new Dr(), this.je = new Cr(this.Qe), this.ze = new xr(this.Qe);
  }
  seed(t) {
    this.Qe.seed(t);
  }
  We(t) {
    return 0 === t ? this.je : this.ze;
  }
  Ge() {
    return this.Qe.Ge();
  }
...
function Mr(t, e) {
  ...
  return 0 !== n ? n : (n = Or(t.arrayValue, e.arrayValue), 0 !== n ? n : (n = Or(t.directionalValue, e.directionalValue), 0 !== n ? n : ht.comparator(t.documentKey, e.documentKey)));
}
function Or(t, e) {
...
var $r = class {
  constructor(t) {
    this.collectionId = null != t.collectionGroup ? t.collectionGroup : t.path.lastSegment(), this.Je = t.orderBy, this.Ye = [];
    for (const e of t.filters) {
      const t2 = e;
      t2.isInequality() ? this.Xe = t2 : this.Ye.push(t2);
    }
  }
  /**
  ...
  Ze(t) {
    ...
    if (void 0 !== this.Xe) {
      const t2 = n[s];
      if (!this.en(this.Xe, t2) || !this.nn(this.Je[i++], t2))
        return false;
      ++s;
    }
    for (; s < n.length; ++s) {
      const t2 = n[s];
      if (i >= this.Je.length || !this.nn(this.Je[i++], t2))
        return false;
    }
    return true;
  }
...
var Jr = class {
  constructor(t, e) {
     ...
     */
    this.on = new os((t2) => On(t2), (t2, e2) => $n(t2, e2)), this.uid = t.uid || "";
  }
  /**
  ...
  getDocumentsMatchingTarget(t, e) {
    ...
    return vt.forEach(this.un(e), (e2) => this.cn(t, e2).next((t2) => {
      s && (s = !!t2), i.set(e2, t2);
    })).next(() => {
      if (s) {
        let t2 = gs();
        const s2 = [];
        return vt.forEach(i, (i2, r2) => {
          var o;
          N2("IndexedDbIndexManager", `Using index ${o = i2, `id=${o.indexId}|cg=${o.collectionGroup}|f=${o.fields.map((t3) => `${t3.fieldPath}:${t3.kind}`).join(",")}`} to execute ${On(e)}`);
          const u = function(t3, e2) {
            ...
            return new hn(n2, s3);
          }(r2, i2), l2 = this.an(i2, r2, a), f = this.an(i2, r2, h), d = this.hn(i2, r2, c), _ = this.ln(i2.indexId, u, l2, a.inclusive, f, h.inclusive, d);
          return vt.forEach(_, (i3) => n.H(i3, e.limit).next((e2) => {
            e2.forEach((e3) => {
  ...
  ln(t, e, n, s, i, r2, o) {
    ...
    for (let h = 0; h < u; ++h) {
      const u2 = e ? this.fn(e[h / c]) : Hr, l2 = this.dn(t, u2, n[h % c], s), f = this._n(t, u2, i[h % c], r2), d = o.map((e2) => this.dn(
        t,
        u2,
        e2,
        /* inclusive= */
  ...
  cn(t, e) {
    const n = new $r(e), s = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment();
    return this.getFieldIndexes(t, s).next((t2) => {
      let e2 = null;
      for (const s2 of t2) {
        n.Ze(s2) && (!e2 || s2.fields.length > e2.fields.length) && (e2 = s2);
      }
      return e2;
    });
  }
  getIndexType(t, e) {
    let n = 2;
    const s = this.un(e);
    return vt.forEach(s, (e2) => this.cn(t, e2).next((t2) => {
  ...
  mn(t, e) {
    const n = new Nr();
    return br.be._e(We(this.databaseId, e), n.We(function(t2) {
      const e2 = dt(t2);
  ...
  hn(t, e, n) {
    ...
    for (const r2 of dt(t)) {
      const t2 = n[i++];
      for (const n2 of s)
        if (this.gn(e, r2.fieldPath) && Je(t2))
          s = this.yn(s, r2, t2);
        else {
          const e2 = n2.We(r2.kind);
          br.be._e(t2, e2);
        }
    }
    return this.pn(s);
  ...
  yn(t, e, n) {
    ...
    for (const t2 of n.arrayValue.values || [])
      for (const n2 of s) {
        const s2 = new Nr();
        s2.seed(n2.Ge()), br.be._e(t2, s2.We(e.kind)), i.push(s2);
      }
    return i;
  }
  gn(t, e) {
  ...
  getFieldIndexes(t, e) {
    ...
    return (e ? n.j("collectionGroupIndex", IDBKeyRange.bound(e, e)) : n.j()).next((t2) => {
      const e2 = [];
      return vt.forEach(t2, (t3) => s.get([t3.indexId, this.uid]).next((n2) => {
        e2.push(function(t4, e3) {
          const n3 = e3 ? new gt(e3.sequenceNumber, new It(_r(e3.readTime), new ht(Gt(e3.documentKey)), e3.largestBatchId)) : gt.empty(), s2 = t4.fields.map(([t5, e4]) => new wt(at.fromServerFormat(t5), e4));
  ...
  updateCollectionGroup(t, e, n) {
    const s = Zr(t), i = to(t);
    return this.In(t).next((t2) => s.j("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((e2) => vt.forEach(e2, (e3) => i.put(Tr(e3.indexId, this.user, t2, n)))));
  }
  updateIndexEntries(t, e) {
    const n = /* @__PURE__ */ new Map();
    return vt.forEach(e, (e2, s) => {
      const i = n.get(e2.collectionGroup);
      return (i ? vt.resolve(i) : this.getFieldIndexes(t, e2.collectionGroup)).next((i2) => (n.set(e2.collectionGroup, i2), vt.forEach(i2, (n2) => this.Tn(t, e2, n2).next((e3) => {
        const i3 = this.En(s, n2);
        return e3.isEqual(i3) ? vt.resolve() : this.An(t, s, n2, e3, i3);
      }))));
    });
  }
  Rn(t, e, n, s) {
  ...
  vn(t, e, n, s) {
    return Xr(t).delete([s.indexId, this.uid, s.arrayValue, s.directionalValue, this.mn(n, e.key), e.key.path.toArray()]);
  }
  Tn(t, e, n) {
    const s = Xr(t);
    let i = new Ee(Mr);
    ...
    if (null != i) {
      ...
      if (Je(r2))
        for (const i2 of r2.arrayValue.values || [])
          n = n.add(new kr(e.indexId, t.key, this.fn(i2), s));
    } else
  ...
  An(t, e, n, s, i) {
    ...
    return function(t2, e2, n2, s2, i2) {
      ...
      for (; u || c; ) {
        ...
        t3 ? (s2(c), c = Re(o)) : e3 ? (i2(u), u = Re(r3)) : (u = Re(r3), c = Re(o));
      }
    }(
      s,
      i,
  ...
  getMinOffset(t, e) {
    return vt.mapArray(this.un(e), (e2) => this.cn(t, e2).next((t2) => t2 || $())).next(eo);
  }
};
function Yr(t) {
...
var oo = class {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    return r2.add({}).next((o) => {
      ...
      const u = new Zs(o, e, n, s), c = function(t2, e2, n2) {
        const s2 = n2.baseMutations.map((e3) => ji(t2.le, e3)), i2 = n2.mutations.map((e3) => ji(t2.le, e3));
        return {
          userId: e2,
          batchId: n2.batchId,
  ...
  lookupMutationBatch(t, e) {
    return co(t).get(e).next((t2) => t2 ? (F2(t2.userId === this.userId), wr(this.serializer, t2)) : null);
  }
  /**
  ...
  // PORTING NOTE: Multi-tab only.
  Vn(t, e) {
    return this.bn[e] ? vt.resolve(this.bn[e]) : this.lookupMutationBatch(t, e).next((t2) => {
      if (t2) {
        const n = t2.keys();
        return this.bn[e] = n, n;
      }
      return null;
    });
  }
  getNextMutationBatchAfterBatchId(t, e) {
    ...
    return co(t).X({
      ...
      e2.userId === this.userId && (F2(e2.batchId >= n), i = wr(this.serializer, e2)), s2.done();
    }).next(() => i);
  }
  ...
  getAllMutationBatches(t) {
    ...
    return co(t).j("userMutationsIndex", e).next((t2) => t2.map((t3) => wr(this.serializer, t3)));
  }
    ...
    return ao(t).X({
      ...
      if (o === this.userId && e.path.isEqual(a))
        return co(t).get(c).next((t2) => {
          if (!t2)
            throw $();
          F2(t2.userId === this.userId), i.push(wr(this.serializer, t2));
        });
      r2.done();
    }).next(() => i);
  }
  ...
  Sn(t, e) {
    ...
    return e.forEach((e2) => {
      s.push(co(t).get(e2).next((t2) => {
        if (null === t2)
          throw $();
        F2(t2.userId === this.userId), n.push(wr(this.serializer, t2));
      }));
    }), vt.waitFor(s).next(() => n);
  }
  removeMutationBatch(t, e) {
    return io(t.at, this.userId, e).next((n) => (t.addOnCommittedListener(() => {
      this.Dn(e.batchId);
    }), vt.forEach(n, (e2) => this.referenceDelegate.markPotentiallyOrphaned(t, e2))));
  }
  /**
...
var fo = class {
  ...
  getLastRemoteSnapshotVersion(t) {
    return this.Mn(t).next((t2) => rt.fromTimestamp(new it(t2.lastRemoteSnapshotVersion.seconds, t2.lastRemoteSnapshotVersion.nanoseconds)));
  }
  getHighestSequenceNumber(t) {
    return this.Mn(t).next((t2) => t2.highestListenSequenceNumber);
  }
  setTargetsMetadata(t, e, n) {
    return this.Mn(t).next((s) => (s.highestListenSequenceNumber = e, n && (s.lastRemoteSnapshotVersion = n.toTimestamp()), e > s.highestListenSequenceNumber && (s.highestListenSequenceNumber = e), this.On(t, s)));
  }
  addTargetData(t, e) {
    return this.$n(t, e).next(() => this.Mn(t).next((n) => (n.targetCount += 1, this.Fn(e, n), this.On(t, n))));
  }
  updateTargetData(t, e) {
    return this.$n(t, e);
  }
  removeTargetData(t, e) {
    return this.removeMatchingKeysForTargetId(t, e.targetId).next(() => _o(t).delete(e.targetId)).next(() => this.Mn(t)).next((e2) => (F2(e2.targetCount > 0), e2.targetCount -= 1, this.On(t, e2)));
  }
  /**
  ...
  Mn(t) {
    return wo(t).get("targetGlobalKey").next((t2) => (F2(null !== t2), t2));
  }
  On(t, e) {
    return wo(t).put("targetGlobalKey", e);
  }
  $n(t, e) {
    return _o(t).put(gr(this.serializer, e));
  }
  /**
  ...
  getTargetCount(t) {
    return this.Mn(t).next((t2) => t2.targetCount);
  }
  getTargetData(t, e) {
    const n = On(e), s = IDBKeyRange.bound([n, Number.NEGATIVE_INFINITY], [n, Number.POSITIVE_INFINITY]);
    let i = null;
    return _o(t).X({
      range: s,
  ...
  removeMatchingKeys(t, e, n) {
    ...
    return vt.forEach(e, (e2) => {
      const i = qt(e2.path);
      return vt.waitFor([s.delete([n, i]), this.referenceDelegate.removeReference(t, n, e2)]);
    });
  }
  ...
  // PORTING NOTE: Multi-tab only.
  he(t, e) {
    return _o(t).get(e).next((t2) => t2 ? mr(t2) : null);
  }
};
function _o(t) {
  return we(t, "targets");
...
var yo = class {
  constructor(t) {
    this.Bn = t, this.buffer = new Ee(go), this.Ln = 0;
  }
  qn() {
    return ++this.Ln;
  }
...
var po = class {
  constructor(t, e, n) {
    this.garbageCollector = t, this.asyncQueue = e, this.localStore = n, this.Kn = null;
  }
  start() {
    -1 !== this.garbageCollector.params.cacheSizeCollectionThreshold && this.Gn(6e4);
  }
  stop() {
    this.Kn && (this.Kn.cancel(), this.Kn = null);
  }
  get started() {
    return null !== this.Kn;
  }
  Gn(t) {
    N2("LruGarbageCollector", `Garbage collection scheduled in ${t}ms`), this.Kn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", t, async () => {
      this.Kn = null;
      try {
        await this.localStore.collectGarbage(this.garbageCollector);
      } catch (t2) {
        Dt(t2) ? N2("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t2) : await Rt(t2);
      }
      await this.Gn(3e5);
    });
  }
...
var Io = class {
  constructor(t, e) {
    this.Qn = t, this.params = e;
  }
  calculateTargetCount(t, e) {
    return this.Qn.jn(t).next((t2) => Math.floor(e / 100 * t2));
  }
  nthSequenceNumber(t, e) {
    if (0 === e)
      return vt.resolve($t.ct);
    const n = new yo(e);
    return this.Qn.forEachTarget(t, (t2) => n.Un(t2.sequenceNumber)).next(() => this.Qn.zn(t, (t2) => n.Un(t2))).next(() => n.maxValue);
  }
  removeTargets(t, e, n) {
    return this.Qn.removeTargets(t, e, n);
  }
  removeOrphanedDocuments(t, e) {
    return this.Qn.removeOrphanedDocuments(t, e);
  }
  collect(t, e) {
    return -1 === this.params.cacheSizeCollectionThreshold ? (N2("LruGarbageCollector", "Garbage collection skipped; disabled"), vt.resolve(no)) : this.getCacheSize(t).next((n) => n < this.params.cacheSizeCollectionThreshold ? (N2("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), no) : this.Wn(t, e));
  }
  getCacheSize(t) {
    return this.Qn.getCacheSize(t);
  }
  Wn(t, e) {
    let n, s, i, r2, o, c, a;
    const h = Date.now();
...
var Eo = class {
  ...
  Yn(t, e) {
    return function(t2, e2) {
      let n = false;
      return ho(t2).Z((s) => uo(t2, s, e2).next((t3) => (t3 && (n = true), vt.resolve(!t3)))).next(() => n);
    }(t, e);
  }
  removeOrphanedDocuments(t, e) {
    const n = this.db.getRemoteDocumentCache().newChangeBuffer(), s = [];
    let i = 0;
    return this.Jn(t, (r2, o) => {
      if (o <= e) {
        const e2 = this.Yn(t, r2).next((e3) => {
          if (!e3)
  ...
  Jn(t, e) {
    ...
    return n.X({
      ...
      0 === t2 ? (
        ...
        (i !== $t.ct && e(new ht(Gt(s)), i), // set nextToReport to be this sequence number. It's the next one we
...
var vo = class {
   ...
   */
  updateMetadata(t, e) {
    return this.getMetadata(t).next((n) => (n.byteSize += e, this.Xn(t, n)));
  }
  getEntry(t, e) {
  ...
  getEntries(t, e) {
    let n = cs();
    return this.es(t, e, (t2, e2) => {
      const s = this.Zn(t2, e2);
      n = n.insert(t2, s);
    }).next(() => n);
  }
  /**
  ...
  getDocumentsMatchingQuery(t, e, n, s) {
    ...
    return So(t).j(IDBKeyRange.bound(r2, o, true)).next((t2) => {
      let n2 = cs();
      for (const i2 of t2) {
        const t3 = this.Zn(ht.fromSegments(i2.prefixPath.concat(i2.collectionGroup, i2.documentId)), i2);
  ...
  getAllFromCollectionGroup(t, e, n, s) {
    ...
    return So(t).X({
      ...
      const r3 = this.Zn(ht.fromSegments(e2.prefixPath.concat(e2.collectionGroup, e2.documentId)), e2);
...
var bo = class extends Ro {
   ...
   */
  constructor(t, e) {
    super(), this.rs = t, this.trackRemovals = e, // A map of document sizes and read times prior to applying the changes in
    // this buffer.
    this.os = new os((t2) => t2.toString(), (t2, e2) => t2.isEqual(e2));
  }
  applyChanges(t) {
    const e = [];
    let n = 0, s = new Ee((t2, e2) => et(t2.canonicalString(), e2.canonicalString()));
    return this.changes.forEach((i, r2) => {
      const o = this.os.get(i);
      if (e.push(this.rs.removeEntry(t, i, o.readTime)), r2.isValidDocument()) {
        const u = lr(this.rs.serializer, r2);
        s = s.add(i.path.popLast());
        const c = ro(u);
        n += c - o.size, e.push(this.rs.addEntry(t, i, u));
      } else if (n -= o.size, this.trackRemovals) {
        const n2 = lr(this.rs.serializer, r2.convertToNoDocument(rt.min()));
        e.push(this.rs.addEntry(t, i, n2));
      }
    }), s.forEach((n2) => {
      e.push(this.rs.indexManager.addToCollectionParentIndex(t, n2));
    }), e.push(this.rs.updateMetadata(t, n)), vt.waitFor(e);
  }
  getFromCache(t, e) {
    return this.rs.ts(t, e).next((t2) => (this.os.set(e, {
      size: t2.size,
      readTime: t2.document.readTime
    }), t2.document));
  }
  getAllFromCache(t, e) {
    return this.rs.ns(t, e).next(({ documents: t2, ss: e2 }) => (
  ...
  getDocumentsMatchingCollectionQuery(t, e, n) {
    ...
    return this.documentOverlayCache.getOverlaysForCollection(t, e.path, n.largestBatchId).next((i) => (s = i, this.remoteDocumentCache.getDocumentsMatchingQuery(t, e, n, s))).next((t2) => {
      ...
      return t2.forEach((t3, i) => {
        const r2 = s.get(t3);
        void 0 !== r2 && Ks(r2.mutation, i, ve.empty(), it.now()), // Finally, insert the documents that still match the query
...
var $o = class {
  constructor() {
    this.ls = new Ee(Fo.fs), // A set of outstanding references to a document sorted by target id.
...
var Bo = class {
  constructor(t, e) {
    ...
    this.As = 1, /** An ordered mapping between documents and the mutations batch IDs. */
  ...
  getAllMutationBatchesAffectingQuery(t, e) {
    ...
    return this.Rs.forEachWhile((t2) => {
      ...
      // TODO(mcg): we'll need a different scanner when we implement
      // ancestor queries.
      (e2.length === s && (o = o.add(t2.Es)), true);
  ...
  removeMutationBatch(t, e) {
    F2(0 === this.Vs(e.batchId, "removed")), this.mutationQueue.shift();
    let n = this.Rs;
...
var Lo = class {
   ...
   */
  constructor(t) {
    this.Ss = t, /** Underlying cache of documents and their read times. */
...
var Uo = class {
  constructor(t) {
     ...
     */
    this.Cs = new os((t2) => On(t2), $n), /** The last received snapshot version. */
...
var Qo = class {
  constructor(t) {
    ...
    this.Gs = new $o(), /** The list of documents that are potentially GCed after each transaction. */
    this.Qs = null;
  }
  static js(t) {
    return new Qo(t);
...
var jo = class {
  constructor(t, e) {
    this.persistence = t, this.Hs = new os((t2) => qt(t2.path), (t2, e2) => t2.isEqual(e2)), this.garbageCollector = To(this, e);
  }
  static js(t, e) {
    return new jo(t, e);
  }
  ...
  zn(t, e) {
    return vt.forEach(this.Hs, (n, s) => this.Yn(t, n, s).next((t2) => t2 ? vt.resolve() : e(s)));
  }
  removeTargets(t, e, n) {
  ...
  removeOrphanedDocuments(t, e) {
    ...
    return s.Ds(t, (s2) => this.Yn(t, s2, e).next((t2) => {
      t2 || (n++, i.removeEntry(s2, rt.min()));
    })).next(() => i.apply(t)).next(() => n);
  }
  markPotentiallyOrphaned(t, e) {
    return this.Hs.set(e, t.currentSequenceNumber), vt.resolve();
  }
  removeTarget(t, e) {
    const n = e.withSequenceNumber(t.currentSequenceNumber);
  ...
  addReference(t, e, n) {
    return this.Hs.set(n, t.currentSequenceNumber), vt.resolve();
  }
  removeReference(t, e, n) {
    return this.Hs.set(n, t.currentSequenceNumber), vt.resolve();
  }
  ...
  Yn(t, e, n) {
    return vt.or([() => this.persistence.Ks(t, e), () => this.persistence.getTargetCache().containsKey(t, e), () => {
      const t2 = this.Hs.get(e);
      return vt.resolve(void 0 !== t2 && t2 > n);
    }]);
  }
  getCacheSize(t) {
...
var zo = class {
  ...
  $(t, e, n, s) {
    ...
    })), n < 5 && s >= 5 && (r2 = r2.next(() => this.Js(i))), n < 6 && s >= 6 && (r2 = r2.next(() => (function(t2) {
      t2.createObjectStore("remoteDocumentGlobal");
    }(t), this.Ys(i)))), n < 7 && s >= 7 && (r2 = r2.next(() => this.Xs(i))), n < 8 && s >= 8 && (r2 = r2.next(() => this.Zs(t, i))), n < 9 && s >= 9 && (r2 = r2.next(() => {
      !function(t2) {
        t2.objectStoreNames.contains("remoteDocumentChanges") && t2.deleteObjectStore("remoteDocumentChanges");
      }(t);
    })), n < 10 && s >= 10 && (r2 = r2.next(() => this.ti(i))), n < 11 && s >= 11 && (r2 = r2.next(() => {
      !function(t2) {
    ...
    }(t)).next(() => this.ei(t, i)).next(() => t.deleteObjectStore("remoteDocuments"))), n < 14 && s >= 14 && (r2 = r2.next(() => this.ni(t, i))), n < 15 && s >= 15 && (r2 = r2.next(() => function(t2) {
  ...
  Js(t) {
    ...
    return e.j().next((e2) => vt.forEach(e2, (e3) => {
      const s = IDBKeyRange.bound([e3.userId, -1], [e3.userId, e3.lastAcknowledgedBatchId]);
      return n.j("userMutationsIndex", s).next((n2) => vt.forEach(n2, (n3) => {
        F2(n3.userId === e3.userId);
        const s2 = wr(this.serializer, n3);
  ...
  ei(t, e) {
    ...
    return n.X((t2, n2) => {
      const i = e.store("remoteDocumentsV14"), r2 = (o = n2, o.document ? new ht(ut.fromString(o.document.name).popFirst(5)) : o.noDocument ? ht.fromSegments(o.noDocument.path) : o.unknownDocument ? ht.fromSegments(o.unknownDocument.path) : $()).path.toArray();
      var o;
      const u = {
  ...
  ni(t, e) {
    const n = e.store("mutations"), s = Po(this.serializer), i = new Ko(Qo.js, this.serializer.le);
    return n.j().next((t2) => {
      const n2 = /* @__PURE__ */ new Map();
      return t2.forEach((t3) => {
        var e2;
        let s2 = null !== (e2 = n2.get(t3.userId)) && void 0 !== e2 ? e2 : gs();
        wr(this.serializer, t3).keys().forEach((t4) => s2 = s2.add(t4)), n2.set(t3.userId, s2);
      }), vt.forEach(n2, (t3, n3) => {
        const r2 = new V2(n3), o = vr.fe(this.serializer, r2), u = i.getIndexManager(r2), c = oo.fe(r2, this.serializer, u, i.referenceDelegate);
        return new ko(s, c, o, u).recalculateAndSaveOverlaysForDocumentKeys(new _e(e, $t.ct), t3).next();
      });
    });
  }
};
...
var Jo = class {
  constructor(t, e, n, s, i, r2, o, u, c, a, h = 15) {
    if (this.allowTabSynchronization = t, this.persistenceKey = e, this.clientId = n, this.si = i, this.window = r2, this.document = o, this.ii = c, this.ri = a, this.oi = h, this.Os = null, this.$s = false, this.isPrimary = false, this.networkEnabled = true, /** Our window.unload handler, if registered. */
    ...
    this.ai = null, /** The last time we garbage collected the client metadata object store. */
    this.hi = Number.NEGATIVE_INFINITY, /** A listener to notify on primary state changes. */
    this.li = (t2) => Promise.resolve(), !Jo.D())
    ...
    this.referenceDelegate = new Eo(this, s), this.fi = e + "main", this.serializer = new ar(u), this.di = new bt(this.fi, this.oi, new zo(this.serializer)), this.Fs = new fo(this.referenceDelegate, this.serializer), this.remoteDocumentCache = Po(this.serializer), this.Ls = new Er(), this.window && this.window.localStorage ? this._i = this.window.localStorage : (this._i = null, false === a && k2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  /**
  ...
  start() {
    return this.wi().then(() => {
      ...
      return this.mi(), this.gi(), this.yi(), this.runTransaction("getHighestListenSequenceNumber", "readonly", (t) => this.Fs.getHighestSequenceNumber(t));
    }).then((t) => {
      this.Os = new $t(t, this.ii);
    }).then(() => {
      this.$s = true;
    }).catch((t) => (this.di && this.di.close(), Promise.reject(t)));
  }
  /**
  ...
  wi() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t) => Xo(t).put({
      ...
      if (this.isPrimary)
        return this.Ii(t).next((t2) => {
          t2 || (this.isPrimary = false, this.si.enqueueRetryable(() => this.li(false)));
        });
    }).next(() => this.Ti(t)).next((e) => this.isPrimary && !e ? this.Ei(t).next(() => false) : !!e && this.Ai(t).next(() => true))).catch((t) => {
      if (Dt(t))
      ...
      this.isPrimary !== t && this.si.enqueueRetryable(() => this.li(t)), this.isPrimary = t;
    });
  }
  Ii(t) {
    return Yo(t).get("owner").next((t2) => vt.resolve(this.Ri(t2)));
  }
  vi(t) {
   ...
   */
  async Pi() {
    if (this.isPrimary && !this.bi(this.hi, 18e5)) {
      this.hi = Date.now();
      const t = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t2) => {
        const e = we(t2, "clientMetadata");
        return e.j().next((t3) => {
          const n = this.Vi(t3, 18e5), s = t3.filter((t4) => -1 === n.indexOf(t4));
          return vt.forEach(s, (t4) => e.delete(t4.clientId)).next(() => s);
        });
      }).catch(() => []);
      if (this._i)
        for (const e of t)
          this._i.removeItem(this.Si(e.clientId));
    }
  }
  /**
   ...
   */
  yi() {
    this.ai = this.si.enqueueAfterDelay("client_metadata_refresh", 4e3, () => this.wi().then(() => this.Pi()).then(() => this.yi()));
  }
  ...
  Ti(t) {
    ...
    return Yo(t).get("owner").next((e) => {
      if (null !== e && this.bi(e.leaseTimestampMs, 5e3) && !this.Di(e.ownerId)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || Xo(t).j().next((t2) => void 0 === this.Vi(t2, 5e3).find((t3) => {
  ...
  async shutdown() {
    this.$s = false, this.Ci(), this.ai && (this.ai.cancel(), this.ai = null), this.xi(), this.Ni(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
    // has obtained the primary lease.
    await this.di.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (t) => {
      const e = new _e(t, $t.ct);
      return this.Ei(e).next(() => this.vi(e));
    }), this.di.close(), // Remove the entry marking the client as zombied from LocalStorage since
   ...
   */
  Vi(t, e) {
    return t.filter((t2) => this.bi(t2.updateTimeMs, e) && !this.Di(t2.clientId));
  }
  /**
   ...
   */
  Mi() {
    return this.runTransaction("getActiveClients", "readonly", (t) => Xo(t).j().next((t2) => this.Vi(t2, 18e5).map((t3) => t3.clientId)));
  }
  get started() {
    return this.$s;
  }
  getMutationQueue(t, e) {
    return oo.fe(t, this.serializer, e, this.referenceDelegate);
  }
  getTargetCache() {
    return this.Fs;
  }
  ...
  getIndexManager(t) {
    return new Jr(t, this.serializer.le.databaseId);
  }
  getDocumentOverlayCache(t) {
    return vr.fe(this.serializer, t);
  }
  getBundleCache() {
    return this.Ls;
  }
  runTransaction(t, e, n) {
    ...
    const s = "readonly" === e ? "readonly" : "readwrite", i = 15 === (r2 = this.oi) ? de2 : 14 === r2 ? fe : 13 === r2 ? le : 12 === r2 ? he : 11 === r2 ? ae2 : void $();
    var r2;
    let o;
    return this.di.runTransaction(t, s, i, (s2) => (o = new _e(s2, this.Os ? this.Os.next() : $t.ct), "readwrite-primary" === e ? this.Ii(o).next((t2) => !!t2 || this.Ti(o)).next((e2) => {
      if (!e2)
        throw k2(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = false, this.si.enqueueRetryable(() => this.li(false)), new U2(q2.FAILED_PRECONDITION, Et);
      return n(o);
    }).next((t2) => this.Ai(o).next(() => t2)) : this.Oi(o).next(() => n(o)))).then((t2) => (o.raiseOnCommittedEvent(), t2));
  }
  /**
  ...
  Oi(t) {
    return Yo(t).get("owner").next((t2) => {
      if (null !== t2 && this.bi(t2.leaseTimestampMs, 5e3) && !this.Di(t2.ownerId) && !this.Ri(t2) && !(this.ri || this.allowTabSynchronization && t2.allowTabSynchronization))
        throw new U2(q2.FAILED_PRECONDITION, Ho);
    });
  }
  /**
  ...
  Ei(t) {
    const e = Yo(t);
    return e.get("owner").next((t2) => this.Ri(t2) ? (N2("IndexedDbPersistence", "Releasing primary lease."), e.delete("owner")) : vt.resolve());
  }
  ...
  mi() {
    null !== this.document && "function" == typeof this.document.addEventListener && (this.ci = () => {
      this.si.enqueueAndForget(() => (this.inForeground = "visible" === this.document.visibilityState, this.wi()));
  ...
  gi() {
    var t;
    "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ui = () => {
      this.Ci();
  ...
  Di(t) {
    var e;
    try {
      const n = null !== (null === (e = this._i) || void 0 === e ? void 0 : e.getItem(this.Si(t)));
...
var eu = class {
  ...
  Ui(t, e) {
    ...
    (e = Xn(
      ...
      return this.qi.getDocuments(t, i).next((s3) => this.indexManager.getMinOffset(t, n).next((n2) => {
        ...
        return this.ji(e, r2, i, n2.readTime) ? this.Ui(t, Xn(
          e,
          null,
          "F"
          /* LimitType.First */
  ...
  Ki(t, e, n, s) {
    return Qn(e) || s.isEqual(rt.min()) ? this.Gi(t, e) : this.qi.getDocuments(t, n).next((i) => {
      ...
      return this.ji(e, r2, n, s) ? this.Gi(t, e) : (C2() <= LogLevel.DEBUG && N2("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), es(e)), this.zi(t, r2, e, yt(s, -1)));
    });
  }
  ...
  Gi(t, e) {
    return C2() <= LogLevel.DEBUG && N2("QueryEngine", "Using full collection scan to execute query:", es(e)), this.qi.getDocumentsMatchingQuery(t, e, It.min());
  }
  /**
   ...
   */
  zi(t, e, n, s) {
    return this.qi.getDocumentsMatchingQuery(t, n, s).next((t2) => (
...
var nu = class {
  constructor(t, e, n, s) {
     ...
     */
    this.Hi = new pe(et), /** Maps a target to its targetID. */
    // TODO(wuandy): Evaluate if TargetId can be part of Target.
    this.Ji = new os((t2) => On(t2), $n), /**
     * A per collection group index of the last read time processed by
     * `getNewDocumentChanges()`.
     *
     * PORTING NOTE: This is only used for multi-tab synchronization.
     */
    this.Yi = /* @__PURE__ */ new Map(), this.Xi = t.getRemoteDocumentCache(), this.Fs = t.getTargetCache(), this.Ls = t.getBundleCache(), this.Zi(n);
  }
  Zi(t) {
...
function hu(t, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (t2) => {
    let s;
    return n.Fs.getTargetData(t2, e).next((i) => i ? (
      // This target has been listened to previously, so reuse the
      // previous targetID.
      // TODO(mcg): freshen last accessed date?
      (s = i, vt.resolve(s))
    ) : n.Fs.allocateTargetId(t2).next((i2) => (s = new cr(e, i2, "TargetPurposeListen", t2.currentSequenceNumber), n.Fs.addTargetData(t2, s).next(() => s))));
  }).then((t2) => {
...
function du(t, e) {
  const n = L(t), s = L(n.Fs), i = n.Hi.get(e);
  return i ? Promise.resolve(i.target) : n.persistence.runTransaction("Get target data", "readonly", (t2) => s.he(t2, e).next((t3) => t3 ? t3.target : null));
}
function _u(t, e) {
  const n = L(t), s = n.Yi.get(e) || rt.min();
  return n.persistence.runTransaction("Get new document changes", "readonly", (t2) => n.Xi.getAllFromCollectionGroup(
    t2,
    e,
    yt(s, -1),
    /* limit= */
    Number.MAX_SAFE_INTEGER
  )).then((t2) => (wu(n, e, t2), t2));
}
function wu(t, e, n) {
...
async function mu(t, e, n, s) {
  ...
  let r2 = gs(), o = cs();
  for (const t2 of n) {
    const n2 = e.ir(t2.metadata.name);
    t2.document && (r2 = r2.add(n2));
    const s2 = e.rr(t2);
    s2.setReadTime(e.ur(t2.metadata.readTime)), o = o.insert(n2, s2);
  }
  const u = i.Xi.newChangeBuffer({
    trackRemovals: true
  }), c = await hu(i, function(t2) {
    return Jn(Gn(ut.fromString(`__bundle__/docs/${t2}`)));
  }(s));
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t2) => cu(t2, u, o).next((e2) => (u.apply(t2), e2)).next((e2) => i.Fs.removeMatchingKeysForTargetId(t2, c.targetId).next(() => i.Fs.addMatchingKeys(t2, r2, c.targetId)).next(() => i.localDocuments.getLocalViewOfDocuments(t2, e2.er, e2.nr)).next(() => e2.er)));
}
async function gu(t, e, n = gs()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (t2) => {
    ...
    if (s.snapshotVersion.compareTo(r2) >= 0)
      return i.Ls.saveNamedQuery(t2, e);
    const o = s.withResumeToken(Ve.EMPTY_BYTE_STRING, r2);
    return i.Hi = i.Hi.insert(o.targetId, o), i.Fs.updateTargetData(t2, o).next(() => i.Fs.removeMatchingKeysForTargetId(t2, s.targetId)).next(() => i.Fs.addMatchingKeys(t2, n, s.targetId)).next(() => i.Ls.saveNamedQuery(t2, e));
  });
}
function yu(t, e) {
...
var Ru = class {
  ...
  static cr(t) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Ru(e.clientId, e.onlineState) : (k2("SharedClientState", `Failed to parse online state: ${t}`), null);
  }
};
var vu = class {
  constructor() {
...
var Pu = class {
  constructor(t, e, n, s, i) {
    this.window = t, this.si = e, this.persistenceKey = n, this.dr = s, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this._r = this.wr.bind(this), this.mr = new pe(et), this.started = false, /**
     * Captures WebStorage events that occur before `start()` is called. These
     * events are replayed once `WebStorageSharedClientState` is started.
     */
    this.gr = [];
    const r2 = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.yr = yu(this.persistenceKey, this.dr), this.pr = /** Assembles the key for the current sequence number. */
    function(t2) {
      return `firestore_sequence_number_${t2}`;
    }(this.persistenceKey), this.mr = this.mr.insert(this.dr, new vu()), this.Ir = new RegExp(`^firestore_clients_${r2}_([^_]*)$`), this.Tr = new RegExp(`^firestore_mutations_${r2}_(\\d+)(?:_(.*))?$`), this.Er = new RegExp(`^firestore_targets_${r2}_(\\d+)$`), this.Ar = /** Assembles the key for the online state of the primary tab. */
    function(t2) {
  ...
  async start() {
    ...
    for (const e2 of t) {
      ...
      if (t2) {
        const n = Au.cr(e2, t2);
        n && (this.mr = this.mr.insert(n.clientId, n));
      }
    }
    this.vr();
    const e = this.storage.getItem(this.Ar);
    if (e) {
      const t2 = this.Pr(e);
      t2 && this.br(t2);
    }
    for (const t2 of this.gr)
      this.wr(t2);
    this.gr = [], // Register a window unload hook to remove the client metadata entry from
    // WebStorage even if `shutdown()` was not called.
    this.window.addEventListener("pagehide", () => this.shutdown()), this.started = true;
  }
  writeSequenceNumber(t) {
    this.setItem(this.pr, JSON.stringify(t));
  }
  getAllActiveQueryTargets() {
    return this.Vr(this.mr);
  }
  isActiveQueryTarget(t) {
    let e = false;
    return this.mr.forEach((n, s) => {
  ...
  updateMutationState(t, e, n) {
    this.Sr(t, e, n), // Once a final mutation result is observed by other clients, they no longer
  ...
  addLocalQueryTarget(t) {
    ...
    return this.Cr.hr(t), this.vr(), e;
  }
  removeLocalQueryTarget(t) {
    this.Cr.lr(t), this.vr();
  }
  isLocalQueryTarget(t) {
    return this.Cr.activeTargetIds.has(t);
  }
  clearQueryState(t) {
  ...
  shutdown() {
    this.started && (this.window.removeEventListener("storage", this._r), this.removeItem(this.yr), this.started = false);
  }
  getItem(t) {
  ...
  wr(t) {
    ...
    if (e.storageArea === this.storage) {
      if (N2("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.yr)
      ...
      this.si.enqueueRetryable(async () => {
        if (this.started) {
          if (null !== e.key) {
            if (this.Ir.test(e.key)) {
              if (null == e.newValue) {
                const t2 = this.Or(e.key);
                return this.$r(t2, null);
              }
              {
                const t2 = this.Fr(e.key, e.newValue);
                if (t2)
                  return this.$r(t2.clientId, t2);
              }
            } else if (this.Tr.test(e.key)) {
              if (null !== e.newValue) {
              ...
              if (null !== e.newValue) {
                const t2 = this.qr(e.key, e.newValue);
                if (t2)
                  return this.Ur(t2);
              }
            } else if (e.key === this.Ar) {
              if (null !== e.newValue) {
                const t2 = this.Pr(e.newValue);
                if (t2)
                  return this.br(t2);
              }
            } else if (e.key === this.pr) {
              const t2 = function(t3) {
                let e2 = $t.ct;
                if (null != t3)
                  try {
              ...
              t2 !== $t.ct && this.sequenceNumberHandler(t2);
            } else if (e.key === this.Rr) {
              const t2 = this.Kr(e.newValue);
              await Promise.all(t2.map((t3) => this.syncEngine.Gr(t3)));
            }
          }
        } else
          this.gr.push(e);
  ...
  get Cr() {
    return this.mr.get(this.dr);
  }
  vr() {
    this.setItem(this.yr, this.Cr.ar());
  }
  Sr(t, e, n) {
  ...
  kr(t) {
    ...
    this.storage.setItem(this.Ar, JSON.stringify(e));
  }
  Nr(t, e, n) {
   ...
   */
  Br(t, e) {
    const n = this.Tr.exec(t), s = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
    return Tu.cr(new V2(i), s, e);
  }
  /**
   ...
   */
  qr(t, e) {
    const n = this.Er.exec(t), s = Number(n[1]);
    return Eu.cr(s, e);
  }
  /**
  ...
  async Lr(t) {
    if (t.user.uid === this.currentUser.uid)
      return this.syncEngine.Qr(t.batchId, t.state, t.error);
    N2("SharedClientState", `Ignoring mutation for non-active user ${t.user.uid}`);
  }
  Ur(t) {
    return this.syncEngine.jr(t.targetId, t.state, t.error);
  }
  $r(t, e) {
    const n = e ? this.mr.insert(t, e) : this.mr.remove(t), s = this.Vr(this.mr), i = this.Vr(n), r2 = [], o = [];
    return i.forEach((t2) => {
      s.has(t2) || r2.push(t2);
    }), s.forEach((t2) => {
      i.has(t2) || o.push(t2);
    }), this.syncEngine.zr(r2, o).then(() => {
      this.mr = n;
    });
  }
  br(t) {
    this.mr.get(t.clientId) && this.onlineStateHandler(t.onlineState);
  }
  Vr(t) {
    let e = ps();
...
class {
  ...
  po(t, e, n, s, i) {
    ...
    const u = {};
    return this.To(u, s, i), this.Eo(t, o, u, n).then((e2) => (N2("RestConnection", `Received RPC '${t}' ${r2}: `, e2), e2), (e2) => {
  ...
  Ro(t, e, n) {
    ...
    this.useFetchStreams && (u.xmlHttpFactory = new FetchXmlHttpFactory({})), this.To(u.initMessageHeaders, e, n), // Sending the custom headers we just added to request.initMessageHeaders
    ...
    const c = i.join("");
    N2(ku, `Creating RPC '${t}' stream ${s}: ${c}`, u);
    const a = r2.createWebChannel(c, u);
    let h = false, l2 = false;
    const f = new Nu({
      io: (e2) => {
        l2 ? N2(ku, `Not sending because RPC '${t}' stream ${s} is closed:`, e2) : (h || (N2(ku, `Opening RPC '${t}' stream ${s} transport.`), a.open(), h = true), N2(ku, `RPC '${t}' stream ${s} sending:`, e2), a.send(e2));
      },
      ro: () => a.close()
    }), d = (t2, e2, n2) => {
      t2.listen(e2, (t3) => {
    ...
    return d(a, WebChannel.EventType.OPEN, () => {
      l2 || N2(ku, `RPC '${t}' stream ${s} transport opened.`);
    }), d(a, WebChannel.EventType.CLOSE, () => {
      l2 || (l2 = true, N2(ku, `RPC '${t}' stream ${s} transport closed`), f.fo());
    }), d(a, WebChannel.EventType.ERROR, (e2) => {
      l2 || (l2 = true, M2(ku, `RPC '${t}' stream ${s} transport errored:`, e2), f.fo(new U2(q2.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!l2) {
        ...
        if (o2) {
          ...
          l2 = true, f.fo(new U2(n3, i3)), a.close();
        } else
          N2(ku, `RPC '${t}' stream ${s} received:`, i2), f._o(i2);
      }
...
var Bu = class {
  constructor(t, e, n = 1e3, s = 1.5, i = 6e4) {
    this.si = t, this.timerId = e, this.vo = n, this.Po = s, this.bo = i, this.Vo = 0, this.So = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  xo(t) {
    ...
    s > 0 && N2("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Vo} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), this.So = this.si.enqueueAfterDelay(this.timerId, s, () => (this.Do = Date.now(), t())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
var Lu = class {
  constructor(t, e, n, s, i, r2, o, u) {
    this.si = t, this.Mo = n, this.Oo = s, this.connection = i, this.authCredentialsProvider = r2, this.appCheckCredentialsProvider = o, this.listener = u, this.state = 0, /**
   ...
   */
  async close(t, e) {
    this.Wo(), this.Ho(), this.Lo.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
    ...
    this.$o++, 4 !== t ? (
      ...
      (k2(e.toString()), k2("Using maximum backoff delay to prevent overloading the backend."), this.Lo.Co())
    ...
    null !== this.stream && (this.Jo(), this.stream.close(), this.stream = null), // This state must be assigned before calling onClose() to allow the callback to
  ...
  auth() {
    ...
    Promise.all([this.authCredentialsProvider.getToken(), this.appCheckCredentialsProvider.getToken()]).then(([t2, n]) => {
      this.$o === e && // Normally we'd have to schedule the callback on the AsyncQueue.
  ...
  Yo(t) {
    return (e) => {
      this.si.enqueueAndForget(() => this.$o === t ? e() : (N2("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
};
...
var Uu = class extends Lu {
  ...
  onMessage(t) {
    if (
      ...
      F2(!!t.streamToken), this.lastStreamToken = t.streamToken, this.iu
    ) {
      this.Lo.reset();
      const e = Wi(t.writeResults, t.commitTime), n = Ni(t.commitTime);
      return this.listener.uu(n, e);
    }
    return F2(!t.writeResults || 0 === t.writeResults.length), this.iu = true, this.listener.cu();
  }
  /**
...
async function Gu(t, e, n) {
  var s;
  const i = L(t), { request: r2, fu: o } = function(t2, e2, n2) {
    const s2 = Ji(t2, e2), i2 = {}, r3 = [];
    let o2 = 0;
    return n2.forEach((t3) => {
      const e3 = "aggregate_" + o2++;
      i2[e3] = t3.alias, "count" === t3.gt ? r3.push({
        alias: e3,
        count: {}
      }) : "avg" === t3.gt ? r3.push({
        alias: e3,
  ...
  i.connection.yo || delete r2.parent;
  const c = (await i.Ao(
    "RunAggregationQuery",
    u,
    r2,
...
var Qu = class {
  ...
  mu() {
    0 === this.du && (this.gu(
      "Unknown"
      /* OnlineState.Unknown */
    ), this._u = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this._u = null, this.yu("Backend didn't respond within 10 seconds."), this.gu(
      "Offline"
      /* OnlineState.Offline */
    ), Promise.resolve())));
  }
   ...
   */
  pu(t) {
    "Online" === this.state ? this.gu(
      "Unknown"
      /* OnlineState.Unknown */
    ) : (this.du++, this.du >= 1 && (this.Iu(), this.yu(`Connection failed 1 times. Most recent error: ${t.toString()}`), this.gu(
      "Offline"
      /* OnlineState.Offline */
    )));
  }
   ...
   */
  set(t) {
    this.Iu(), this.du = 0, "Online" === t && // We've connected to watch at least once. Don't warn the developer
    // about being offline going forward.
    (this.wu = false), this.gu(t);
  }
  gu(t) {
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.wu ? (k2(e), this.wu = false) : N2("OnlineStateTracker", e);
  }
  Iu() {
...
var ju = class {
  constructor(t, e, n, s, i) {
     ...
     */
    this.Ru = [], this.vu = i, this.vu.Jr((t2) => {
...
function Hu(t, e) {
  const n = L(t);
  n.Eu.has(e.targetId) || // Mark this as something the client is currently listening for.
  (n.Eu.set(e.targetId, e), tc2(n) ? (
...
function Ju(t, e) {
  const n = L(t), s = pc2(n);
  n.Eu.delete(e), s.Uo() && Xu(n, e), 0 === n.Eu.size && (s.Uo() ? s.Qo() : ec2(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
function tc2(t) {
  return ec2(t) && !pc2(t).qo() && t.Eu.size > 0;
}
function ec2(t) {
      ...
      */
      function(t2, e3) {
        ...
        n2.targetMismatches.forEach((e4, n3) => {
          ...
          if (!s)
            return;
          t2.Eu.set(e4, s.withResumeToken(Ve.EMPTY_BYTE_STRING, s.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function oc2(t, e, n) {
  ...
  t.asyncQueue.enqueueRetryable(async () => {
    N2("RemoteStore", "Retrying IndexedDB access"), await n(), t.Au.delete(
      1
      /* OfflineCause.IndexedDbFailed */
    ), await zu(t);
  });
...
function lc2(t) {
  return ec2(t) && !Ic2(t).qo() && t.Tu.length > 0;
}
function fc2(t) {
  Ic2(t).start();
}
...
async function mc2(t, e) {
  e && Ic2(t).ru && // This error affects the actual write.
  await async function(t2, e2) {
    if (n = e2.code, oi(n) && n !== q2.ABORTED) {
      const n2 = t2.Tu.shift();
      Ic2(t2).Go(), await uc2(t2, () => t2.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), // It's possible that with the completion of this mutation
...
async function gc2(t, e) {
  ...
  n.Pu.set(
    "Unknown"
    /* OnlineState.Unknown */
  ), await n.remoteSyncer.handleCredentialChange(e), n.Au.delete(
    3
    /* OfflineCause.CredentialChange */
  ), await zu(n);
}
...
function pc2(t) {
  return t.Vu || // Create stream (but note that it is not started yet).
  (t.Vu = function(t2, e, n) {
    const s = L(t2);
    ...
    e ? (t.Vu.Go(), tc2(t) ? Zu(t) : t.Pu.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (await t.Vu.stop(), nc2(t));
  })), t.Vu;
}
function Ic2(t) {
  ...
  (t.Su = function(t2, e, n) {
    ...
    e ? (t.Su.Go(), // This will start the write stream if necessary.
    await cc2(t)) : (await t.Su.stop(), t.Tu.length > 0 && (N2("RemoteStore", `Stopping write stream with ${t.Tu.length} pending writes`), t.Tu = []));
  })), t.Su;
}
var Tc2 = class {
  constructor(t, e, n, s, i) {
...
var Rc2 = class {
  ...
  track(t) {
    ...
    n ? (
      ...
      0 !== t.type && 3 === n.type ? this.Du = this.Du.insert(e, t) : 3 === t.type && 1 !== n.type ? this.Du = this.Du.insert(e, {
        type: n.type,
        doc: t.doc
...
var Nc2 = class {
  constructor(t, e, n) {
     ...
     */
    this.$u = false, this.Fu = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
  ...
  qu(t) {
    t = vc2.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache, t.hasCachedResults), this.$u = true, this.Ou.next(t);
  }
};
var kc2 = class {
  constructor(t, e) {
...
var Mc2 = class {
  ...
  ir(t) {
    return $i(this.serializer, t);
  }
  /**
   * Converts a BundleDocument to a MutableDocument.
   */
  rr(t) {
    return t.metadata.exists ? Ki(this.serializer, t.document, false) : an.newNoDocument(this.ir(t.metadata.name), this.ur(t.metadata.readTime));
  }
  ur(t) {
    return Ni(t);
  }
...
var Oc2 = class {
  constructor(t, e, n) {
    this.Qu = t, this.localStore = e, this.serializer = n, /** Batched queries to be saved into storage */
    this.queries = [], /** Batched documents to be saved into storage */
    this.documents = [], /** The collection groups affected by this bundle. */
    this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = $c2(t);
  }
  /**
  ...
  ju(t) {
    ...
    if (t.Ku.namedQuery)
      this.queries.push(t.Ku.namedQuery);
    else if (t.Ku.documentMetadata) {
      this.documents.push({
        metadata: t.Ku.documentMetadata
      }), t.Ku.documentMetadata.exists || ++e;
      const n = ut.fromString(t.Ku.documentMetadata.name);
      this.collectionGroups.add(n.get(n.length - 2));
    } else
      t.Ku.document && (this.documents[this.documents.length - 1].document = t.Ku.document, ++e);
   ...
   */
  async complete() {
    const t = await mu(this.localStore, new Mc2(this.serializer), this.documents, this.Qu.id), e = this.zu(this.documents);
...
var Lc2 = class {
  constructor(t, e) {
    this.query = t, this.Ju = e, this.Yu = null, this.hasCachedResults = false, /**
    ...
    this.Xu = gs(), /** Document Keys that have local changes */
    this.mutatedKeys = gs(), this.Zu = is(t), this.tc = new Ac2(this.Zu);
  }
  /**
   ...
   */
  nc(t, e) {
    const n = e ? e.sc : new Rc2(), s = e ? e.tc : this.tc;
    ...
    if (t.inorderTraversal((t2, e2) => {
      ...
      if (a && h) {
        a.data.isEqual(h.data) ? l2 !== f && (n.track({
          ...
          type: 2,
          doc: h
        }), d = true, (u && this.Zu(h, u) > 0 || c && this.Zu(h, c) < 0) && // This doc moved from inside the limit to outside the limit.
   ...
   */
  cc(t) {
    return !this.Ju.has(t) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
  ...
  oc() {
    ...
    const e = [];
    return t.forEach((t2) => {
      this.Xu.has(t2) || e.push(new Bc2(t2));
    }), this.Xu.forEach((n) => {
  ...
  // PORTING NOTE: Multi-tab only.
  hc() {
    return vc2.fromInitialDocuments(this.query, this.tc, this.mutatedKeys, 0 === this.Yu, this.hasCachedResults);
  }
};
var qc2 = class {
  constructor(t, e, n) {
...
var Kc2 = class {
  constructor(t, e, n, s, i, r2) {
    this.localStore = t, this.remoteStore = e, this.eventManager = n, this.sharedClientState = s, this.currentUser = i, this.maxConcurrentLimboResolutions = r2, this.fc = {}, this.dc = new os((t2) => ts(t2), Zn), this._c = /* @__PURE__ */ new Map(), /**
     ...
     */
    this.gc = /* @__PURE__ */ new Map(), this.yc = new $o(), /** Stores user completion handlers, indexed by User and BatchId. */
    this.Ic = {}, /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    this.Tc = /* @__PURE__ */ new Map(), this.Ec = lo.kn(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
...
async function Qc2(t, e, n, s, i) {
  t.Rc = (e2, n2, s2) => async function(t2, e3, n3, s3) {
    ...
    i2.ji && // The query has a limit and some docs were removed, so we need
  ...
  const r2 = await fu(
    ...
    /* usePreviousResults= */
    true
  ), o = new Lc2(e, r2.sr), u = o.nc(r2.documents), c = gi.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t.onlineState, i), a = o.applyChanges(
    u,
    /* updateLimboDocuments= */
    t.isPrimaryClient,
    c
...
async function Wc2(t, e) {
  ...
  try {
    ...
    e.targetChanges.forEach((t3, e2) => {
      ...
      (F2(t3.addedDocuments.size + t3.modifiedDocuments.size + t3.removedDocuments.size <= 1), t3.addedDocuments.size > 0 ? s.lc = true : t3.modifiedDocuments.size > 0 ? F2(s.lc) : t3.removedDocuments.size > 0 && (F2(s.lc), s.lc = false));
    }), await ua2(n, t2, e);
  } catch (t2) {
    await Rt(t2);
  }
...
async function Jc2(t, e, n) {
  ...
  if (r2) {
    ...
    s.mc = s.mc.remove(r2), s.gc.delete(e), oa2(s);
  } else
    await lu(
      s.localStore,
      e,
...
function na2(t, e, n = null) {
  ...
  if (t._c.delete(e), t.isPrimaryClient) {
    t.yc.ps(e).forEach((e2) => {
      t.yc.containsKey(e2) || // We removed the last reference for this key
      sa2(t, e2);
    });
  }
}
function sa2(t, e) {
  ...
  const n = t.mc.get(e);
  null !== n && (Ju(t.remoteStore, n), t.mc = t.mc.remove(e), t.gc.delete(n), oa2(t));
}
function ia(t, e, n) {
  for (const s of n)
    if (s instanceof Fc2)
      t.yc.addReference(s.key, e), ra2(t, s);
    else if (s instanceof Bc2) {
      N2("SyncEngine", "Document no longer in limbo: " + s.key), t.yc.removeReference(s.key, e);
      t.yc.containsKey(s.key) || // We removed the last reference for this key
      sa2(t, s.key);
    } else
      $();
}
function ra2(t, e) {
  ...
  t.mc.get(n) || t.wc.has(s) || (N2("SyncEngine", "New document in limbo: " + n), t.wc.add(s), oa2(t));
}
function oa2(t) {
  for (; t.wc.size > 0 && t.mc.size < t.maxConcurrentLimboResolutions; ) {
    ...
    t.gc.set(s, new Uc2(n)), t.mc = t.mc.insert(n, s), Hu(t.remoteStore, new cr(Jn(Gn(n.path)), s, "TargetPurposeLimboResolution", $t.ct));
  }
}
...
async function ca2(t, e) {
  ...
  if (!n.currentUser.isEqual(e)) {
    ...
    n.sharedClientState.handleUserChange(e, t2.removedBatchIds, t2.addedBatchIds), await ua2(n, t2.tr);
  }
}
function aa2(t, e) {
...
async function ha2(t, e) {
  ...
  return n.isPrimaryClient && ia(n, e.targetId, i.uc), i;
}
async function la(t, e) {
  const n = L(t);
  return _u(n.localStore, e).then((t2) => ua2(n, t2));
}
async function fa2(t, e, n, s) {
  const i = L(t), r2 = await function(t2, e2) {
    const n2 = L(t2), s2 = L(n2.mutationQueue);
    return n2.persistence.runTransaction("Lookup mutation documents", "readonly", (t3) => s2.Vn(t3, e2).next((e3) => e3 ? n2.localDocuments.getDocuments(t3, e3) : vt.resolve(null)));
  }(i.localStore, e);
  null !== r2 ? ("pending" === n ? (
...
async function da2(t, e) {
  const n = L(t);
  if (pa2(n), Ia2(n), true === e && true !== n.Ac) {
    const t2 = n.sharedClientState.getAllActiveQueryTargets(), e2 = await _a(n, t2.toArray());
    n.Ac = true, await yc2(n.remoteStore, true);
    for (const t3 of e2)
      Hu(n.remoteStore, t3);
    ...
    }), await e2, await _a(n, t2), // PORTING NOTE: Multi-Tab only.
    function(t3) {
      const e3 = L(t3);
      e3.gc.forEach((t4, n2) => {
        Ju(e3.remoteStore, n2);
      }), e3.yc.Is(), e3.gc = /* @__PURE__ */ new Map(), e3.mc = new pe(ht.comparator);
    }(n), n.Ac = false, await yc2(n.remoteStore, false);
  }
}
async function _a(t, e, n) {
  ...
  for (const t2 of e) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      for (const t3 of n2) {
        const e3 = s.dc.get(t3), n3 = await ha2(s, e3);
...
function ma2(t) {
  const e = L(t);
  return L(L(e.localStore).persistence).Mi();
}
async function ga(t, e, n, s) {
  ...
  if (r2 && r2.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t2 = await _u(i.localStore, ss(r2[0])), s2 = mi.createSynthesizedRemoteEventForCurrentChange(e, "current" === n, Ve.EMPTY_BYTE_STRING);
        await ua2(i, t2, s2);
        break;
      }
      case "rejected":
...
function pa2(t) {
  const e = L(t);
  return e.remoteStore.remoteSyncer.applyRemoteEvent = Wc2.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = aa2.bind(null, e), e.remoteStore.remoteSyncer.rejectListen = Jc2.bind(null, e), e.fc.eu = Dc2.bind(null, e.eventManager), e.fc.vc = Cc2.bind(null, e.eventManager), e;
}
function Ia2(t) {
  const e = L(t);
  ...
  (async function(t2, e2, n2) {
    try {
      ...
      if (await function(t3, e3) {
        ...
        return n3.persistence.runTransaction("hasNewerBundle", "readonly", (t4) => n3.Ls.getBundleMetadata(t4, e3.id)).then((t4) => !!t4 && t4.createTime.compareTo(s3) >= 0);
      }(t2.localStore, s2))
      ...
      n2._updateProgress($c2(s2));
      const i = new Oc2(s2, t2.localStore, e2.serializer);
      let r2 = await e2.Pc();
      for (; r2; ) {
        const t3 = await i.ju(r2);
        t3 && n2._updateProgress(t3), r2 = await e2.Pc();
      }
      ...
      await function(t3, e3) {
        const n3 = L(t3);
        return n3.persistence.runTransaction("Save bundle", "readwrite", (t4) => n3.Ls.saveBundleMetadata(t4, e3));
      }(t2.localStore, s2), n2._completeWith(o.progress), Promise.resolve(o.Wu);
    } catch (t3) {
...
var Aa2 = class extends Ea {
  ...
  createPersistence(t) {
    ...
    return new Ko((t2) => jo.js(t2, e), this.serializer);
  }
};
var Ra2 = class extends Ea {
  constructor(t, e, n) {
    super(), this.bc = t, this.cacheSizeBytes = e, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(t) {
    await super.initialize(t), await this.bc.initialize(this, t), // Enqueue writes from a previous session
    await Ia2(this.bc.syncEngine), await cc2(this.bc.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
  ...
  createPersistence(t) {
    ...
    return new Jo(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Ou(), $u(), this.serializer, this.sharedClientState, !!this.forceOwnership);
  }
  createSharedClientState(t) {
    return new bu();
  }
};
var va2 = class extends Ra2 {
  constructor(t, e) {
    super(
      t,
      e,
      /* forceOwnership= */
      false
    ), this.bc = t, this.cacheSizeBytes = e, this.synchronizeTabs = true;
  }
  async initialize(t) {
    ...
    // set it after localStore / remoteStore are started.
    await this.persistence.pi(async (t2) => {
      await da2(this.bc.syncEngine, t2), this.gcScheduler && (t2 && !this.gcScheduler.started ? this.gcScheduler.start() : t2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (t2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : t2 || this.indexBackfillerScheduler.stop());
    });
  }
  createSharedClientState(t) {
    const e = Ou();
...
var Pa2 = class {
  ...
  terminate() {
    return async function(t) {
      const e = L(t);
      N2("RemoteStore", "RemoteStore shutting down."), e.Au.add(
        5
        /* OfflineCause.Shutdown */
      ), await Wu(e), e.vu.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var Va2 = class {
  ...
  error(t) {
    this.observer.error ? this.Vc(this.observer.error, t) : k2("Uncaught Error in snapshot listener:", t.toString());
  }
  Sc() {
    this.muted = true;
  }
...
var Sa2 = class {
  constructor(t, e) {
    this.Dc = t, this.serializer = e, /** Cached bundle metadata. */
    this.metadata = new K2(), /**
     * Internal buffer to hold bundle content, accumulating incomplete element
     * content.
     */
    this.buffer = new Uint8Array(), this.Cc = new TextDecoder("utf-8"), // Read the metadata (which is the first element).
    this.xc().then((t2) => {
      t2 && t2.Gu() ? this.metadata.resolve(t2.Ku.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == t2 ? void 0 : t2.Ku)}`));
    }, (t2) => this.metadata.reject(t2));
  }
  close() {
    return this.Dc.cancel();
  }
  async getMetadata() {
    return this.metadata.promise;
  }
  async Pc() {
    return await this.getMetadata(), this.xc();
  }
  /**
  ...
  async xc() {
    ...
    if (null === t)
      return null;
    const e = this.Cc.decode(t), n = Number(e);
    isNaN(n) && this.kc(`length string (${e}) is not valid number`);
  ...
  async Nc() {
    ...
    if (0 === this.buffer.length)
      return null;
    const t = this.Oc();
    t < 0 && this.kc("Reached the end of bundle when a length string is expected.");
  ...
  async Mc(t) {
    for (; this.buffer.length < t; ) {
      await this.$c() && this.kc("Reached the end of bundle when more is expected.");
    }
    const e = this.Cc.decode(this.buffer.slice(0, t));
    return this.buffer = this.buffer.slice(t), e;
  }
  kc(t) {
    throw this.Dc.cancel(), new Error(`Invalid bundle format: ${t}`);
  }
  /**
  ...
  async lookup(t) {
    ...
    const e = await async function(t2, e2) {
      const n = L(t2), s = Li(n.serializer) + "/documents", i = {
        documents: e2.map((t3) => Oi(n.serializer, t3))
      }, r2 = await n.Ao("BatchGetDocuments", s, i, e2.length), o = /* @__PURE__ */ new Map();
      r2.forEach((t3) => {
...
var Ca2 = class {
  constructor(t, e, n, s, i) {
    this.asyncQueue = t, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.Fc = n.maxAttempts, this.Lo = new Bu(
      this.asyncQueue,
      "transaction_retry"
  ...
  Bc() {
    this.Lo.xo(async () => {
      const t = new Da(this.datastore), e = this.Lc(t);
      e && e.then((e2) => {
  ...
  qc(t) {
    this.Fc > 0 && this.Uc(t) ? (this.Fc -= 1, this.asyncQueue.enqueueAndForget(() => (this.Bc(), Promise.resolve()))) : this.deferred.reject(t);
  }
  Uc(t) {
...
function Fa(t) {
  return Oa2(t).then((t2) => t2.persistence);
}
function Ba2(t) {
  return Oa2(t).then((t2) => t2.localStore);
}
function La(t) {
  return $a(t).then((t2) => t2.remoteStore);
}
function qa2(t) {
  return $a(t).then((t2) => t2.syncEngine);
}
function Ua2(t) {
  return $a(t).then((t2) => t2.datastore);
}
  ...
  return t.asyncQueue.enqueueAndForget(async () => async function(t2, e2, n2) {
    try {
      const s = await fu(
        ...
        /* usePreviousResults= */
        true
      ), i = new Lc2(e2, s.sr), r2 = i.nc(s.documents), o = i.applyChanges(
        r2,
        /* updateLimboDocuments= */
        false
      );
...
function Ja(t, e) {
  ...
  return t.asyncQueue.enqueueAndForget(async () => function(t2, e2) {
    L(t2).Nu.add(e2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    e2.next();
  }(await Ka2(t), n)), () => {
    n.Sc(), t.asyncQueue.enqueueAndForget(async () => function(t2, e2) {
      L(t2).Nu.delete(e2);
    }(await Ka2(t), n));
  };
}
...
function Xa2(t, e) {
  return t.asyncQueue.enqueue(async () => function(t2, e2) {
    const n = L(t2);
    return n.persistence.runTransaction("Get named query", "readonly", (t3) => n.Ls.getNamedQuery(t3, e2));
  }(await Ba2(t), e));
}
function Za2(t, e) {
...
var ch = class {
  constructor(t) {
    ...
    nh("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling), this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalForceLongPolling ? this.experimentalAutoDetectLongPolling = false : void 0 === t.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = false : (
...
var ah = class {
  ...
  constructor(t, e, n, s) {
     ...
     */
    this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new ch({}), this._settingsFrozen = false;
  }
  /**
  ...
  _terminate() {
    return function(t) {
      const e = th.get(t);
      e && (N2("ComponentProvider", "Removing Datastore"), th.delete(t), e.terminate());
...
function wh(t, e) {
  if (t = oh(t, ah), eh("collectionGroup", "collection id", e), e.indexOf("/") >= 0)
...
function mh(t, e, ...n) {
  ...
  // 'undefined' and 'null'.
  1 === arguments.length && (e = tt.A()), eh("doc", "path", e), t instanceof ah) {
    const s = ut.fromString(e, ...n);
    return sh(s), new lh(
      t,
      /* converter= */
...
function gh(t, e) {
  return t = getModularInstance(t), e = getModularInstance(e), (t instanceof lh || t instanceof dh) && (e instanceof lh || e instanceof dh) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
function yh(t, e) {
  return t = getModularInstance(t), e = getModularInstance(e), t instanceof fh && e instanceof fh && (t.firestore === e.firestore && Zn(t._query, e._query) && t.converter === e.converter);
}
var ph = class {
  constructor() {
    this.Kc = Promise.resolve(), // A list of retryable operations. Retryable operations are run in order and
    ...
    this.jc = [], // visible for testing
    this.zc = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.Wc = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.Hc = false, // List of TimerIds to fast-forward delays for.
    ...
    this.Yc = () => {
      const t2 = $u();
      t2 && N2("AsyncQueue", "Visibility state changed to " + t2.visibilityState), this.Lo.ko();
    };
    const t = $u();
  ...
  enqueueAndForgetEvenWhileRestricted(t) {
    this.Xc(), // eslint-disable-next-line @typescript-eslint/no-floating-promises
    this.Zc(t);
  }
  ...
  enqueueAfterDelay(t, e, n) {
    this.Xc(), // Fast-forward delays for timerIds that have been overriden.
    this.Jc.indexOf(t) > -1 && (e = 0);
    const s = Tc2.createAndSchedule(this, t, e, n, (t2) => this.ea(t2));
...
function Vh(t, e) {
  ...
  return Dh(n, i, new Ra2(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
function Sh(t) {
  Fh(t = oh(t, Ah));
  const e = Ph(t);
  ...
  return Dh(e, s, new va2(s, n.cacheSizeBytes));
}
function Dh(t, e, n) {
  const s = new K2();
  return t.asyncQueue.enqueue(async () => {
...
function Nh(t) {
  return Ga2(Ph(t = oh(t, Ah)));
}
function kh(t) {
  return Qa2(Ph(t = oh(t, Ah)));
}
function Mh(t) {
  return _removeServiceInstance(t.app, "firestore", t._databaseId.database), t._delete();
}
function Oh(t, e) {
  const n = Ph(t = oh(t, Ah)), s = new Th();
  return Ya2(n, t._databaseId, e, s), s;
}
function $h(t, e) {
  return Xa2(Ph(t = oh(t, Ah)), e).then((e2) => e2 ? new fh(t, null, e2.query) : null);
}
function Fh(t) {
  if (t._initialized || t._terminated)
...
var Jh = class {
  ...
  constructor(t, e, n, s, i, r2) {
    ...
    void 0 === i && this.oa(), this.fieldTransforms = i || [], this.fieldMask = r2 || [];
  }
  get path() {
...
var sl = class extends Gh {
  ...
  _toFieldTransform(t) {
    const e = el(
      ...
      /*array=*/
      true
    ), n = this.ya.map((t2) => al(t2, e)), s = new Vs(n);
...
var il = class extends Gh {
  ...
  _toFieldTransform(t) {
    const e = el(
      ...
      /*array=*/
      true
    ), n = this.ya.map((t2) => al(t2, e)), s = new Ds(n);
    return new Ms(t.path, s);
  }
  isEqual(t) {
    return this === t;
...
var rl = class extends Gh {
  constructor(t, e) {
    super(t), this.pa = e;
  }
  _toFieldTransform(t) {
    const e = new xs(t.serializer, Es(t.serializer, this.pa));
...
function dl(t, e, n) {
  if (
    ...
    // FieldPath.
    (e = getModularInstance(e)) instanceof Uh
  )
...
function Vl(...t) {
  return t.forEach((t2) => jl("or", t2)), bl._create("or", t);
}
function Sl(...t) {
  return t.forEach((t2) => jl("and", t2)), bl._create("and", t);
}
var Dl = class extends Al {
  /**
   * @internal
   */
  constructor(t, e) {
...
var xl = class extends Al {
  ...
  _apply(t) {
    return new fh(t.firestore, t.converter, Xn(t._query, this._limit, this._limitType));
  }
};
function Nl(t) {
  return uh("limit", t), xl._create(
    "limit",
    t,
    "F"
    /* LimitType.First */
...
function kl(t) {
  return uh("limitToLast", t), xl._create(
    "limitToLast",
    t,
    "L"
    /* LimitType.Last */
...
function ql(t, e, n, s) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof yl)
...
function Ul(t, e, n) {
  ...
  if (n instanceof lh)
    return We(t, n._key);
  throw new U2(q2.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${rh(n)}.`);
}
function Kl(t, e) {
...
function jl(t, e) {
  if (!(e instanceof vl || e instanceof bl))
...
function Jl(t) {
  return new Bh("sum", dl("sum", t));
}
function Yl(t) {
  return new Bh("avg", dl("average", t));
}
function Xl() {
  return new Bh("count");
}
function Zl(t, e) {
  var n, s;
  return t instanceof Bh && e instanceof Bh && t._aggregateType === e._aggregateType && (null === (n = t._internalFieldPath) || void 0 === n ? void 0 : n.canonicalString()) === (null === (s = e._internalFieldPath) || void 0 === s ? void 0 : s.canonicalString());
}
function tf(t, e) {
  return yh(t.query, e.query) && deepEqual(t.data(), e.data());
}
var ef = class {
  /** @hideconstructor */
  constructor(t, e) {
...
function uf(t, e) {
  return t instanceof nf && e instanceof nf ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof rf && e instanceof rf && (t._firestore === e._firestore && yh(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot));
}
function cf(t) {
  t = oh(t, lh);
  const e = oh(t.firestore, Ah);
  return za2(Ph(e), t._key).then((n) => Ef(e, t, n));
}
var af = class extends zl {
  constructor(t) {
    super(), this.firestore = t;
  }
  convertBytes(t) {
...
function hf(t) {
  ...
  return ja2(n, t._key).then((n2) => new nf(e, s, t._key, n2, new ef(
...
function ff(t) {
  t = oh(t, fh);
  const e = oh(t.firestore, Ah), n = Ph(e), s = new af(e);
  return Tl(t._query), Ha2(n, t._query).then((n2) => new rf(e, s, t, n2));
}
function df(t) {
  t = oh(t, fh);
  const e = oh(t.firestore, Ah), n = Ph(e), s = new af(e);
  return Wa2(n, t._query).then((n2) => new rf(e, s, t, n2));
}
function _f(t) {
  t = oh(t, fh);
  const e = oh(t.firestore, Ah), n = Ph(e), s = new af(e);
...
function mf(t, e, n, ...s) {
  ...
  (e = getModularInstance(e)) || e instanceof Uh ? ul(r2, "updateDoc", t._key, e, n, s) : ol(r2, "updateDoc", t._key, e);
...
function pf(t, ...e) {
  ...
  "object" != typeof e[o] || Ih(e[o]) || (r2 = e[o], o++);
  const u = {
  ...
  let c, a, h;
  if (t instanceof lh)
    a = oh(t.firestore, Ah), h = Gn(t._key.path), c = {
      next: (n2) => {
        e[o] && e[o](Ef(a, t, n2));
      },
      error: e[o + 1],
    ...
    const n2 = oh(t, fh);
    a = oh(n2.firestore, Ah), h = n2._query;
    const s2 = new af(a);
    c = {
      next: (t2) => {
        e[o] && e[o](new rf(a, s2, n2, t2));
      },
      error: e[o + 1],
      complete: e[o + 2]
    }, Tl(t._query);
  ...
  return function(t2, e2, n2, s2) {
    ...
    return t2.asyncQueue.enqueueAndForget(async () => Vc2(await Ka2(t2), r3)), () => {
      i2.Sc(), t2.asyncQueue.enqueueAndForget(async () => Sc2(await Ka2(t2), r3));
    };
  }(Ph(a), h, u, c);
}
function If(t, e) {
  return Ja(Ph(t = oh(t, Ah)), Ih(e) ? e : {
    next: e
  });
}
function Tf(t, e) {
...
function Ef(t, e, n) {
  const s = n.docs.get(e._key), i = new af(t);
  return new nf(t, i, e._key, s, new ef(n.hasPendingWrites, n.fromCache), e.converter);
}
function Af(t) {
  return Rf(t, {
    count: Xl()
...
function Rf(t, e) {
  const n = oh(t.firestore, Ah), s = Ph(n), i = function(t2, e2) {
    const n2 = [];
    for (const s2 in t2)
...
var Pf = class {
  constructor(t) {
    let e;
    this.kind = "persistent", (null == t ? void 0 : t.tabManager) ? (t.tabManager._initialize(t), e = t.tabManager) : (e = Mf(void 0), e._initialize(t)), this._onlineComponentProvider = e._onlineComponentProvider, this._offlineComponentProvider = e._offlineComponentProvider;
  }
  toJSON() {
    return {
      kind: this.kind
...
var Nf = class {
   ...
   */
  _initialize(t) {
    this._onlineComponentProvider = new Pa2(), this._offlineComponentProvider = new Ra2(this._onlineComponentProvider, null == t ? void 0 : t.cacheSizeBytes, this.forceOwnership);
  }
};
var kf = class {
  constructor() {
   ...
   */
  _initialize(t) {
    this._onlineComponentProvider = new Pa2(), this._offlineComponentProvider = new va2(this._onlineComponentProvider, null == t ? void 0 : t.cacheSizeBytes);
  }
};
function Mf(t) {
  return new Nf(null == t ? void 0 : t.forceOwnership);
}
function Of() {
  return new kf();
}
...
var Ff = class {
  /** @hideconstructor */
  constructor(t, e) {
    this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = false, this._dataReader = Xh(t);
  }
  set(t, e, n) {
    this._verifyNotCommitted();
    const s = Bf(t, this._firestore), i = Wl(s.converter, e, n), r2 = Zh(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
    return this._mutations.push(r2.toMutation(s._key, Fs.none())), this;
  }
  update(t, e, n, ...s) {
    this._verifyNotCommitted();
    const i = Bf(t, this._firestore);
    let r2;
    return r2 = "string" == typeof (e = getModularInstance(e)) || e instanceof Uh ? ul(this._dataReader, "WriteBatch.update", i._key, e, n, s) : ol(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r2.toMutation(i._key, Fs.exists(true))), this;
  }
  /**
...
var Lf = class extends class {
  /** @hideconstructor */
  constructor(t, e) {
    this._firestore = t, this._transaction = e, this._dataReader = Xh(t);
  }
  /**
   ...
   */
  get(t) {
    const e = Bf(t, this._firestore), n = new Hl(this._firestore);
    return this._transaction.lookup([e._key]).then((t2) => {
      if (!t2 || 1 !== t2.length)
        return $();
      const s = t2[0];
      if (s.isFoundDocument())
        return new yl(this._firestore, n, s.key, s, e.converter);
      if (s.isNoDocument())
        return new yl(this._firestore, n, e._key, null, e.converter);
      throw $();
    });
  }
  set(t, e, n) {
    const s = Bf(t, this._firestore), i = Wl(s.converter, e, n), r2 = Zh(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    return this._transaction.set(s._key, r2), this;
  }
  update(t, e, n, ...s) {
    const i = Bf(t, this._firestore);
    let r2;
    return r2 = "string" == typeof (e = getModularInstance(e)) || e instanceof Uh ? ul(this._dataReader, "Transaction.update", i._key, e, n, s) : ol(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r2), this;
  }
  /**
   * Deletes the document referred to by the provided {@link DocumentReference}.
   *
   ...
   */
  get(t) {
    const e = Bf(t, this._firestore), n = new af(this._firestore);
    return super.get(t).then((t2) => new nf(this._firestore, n, e._key, t2._document, new ef(
      /* hasPendingWrites= */
      false,
      /* fromCache= */
      false
...
function qf(t, e, n) {
  t = oh(t, Ah);
  const s = Object.assign(Object.assign({}, $f), n);
  !function(t2) {
    if (t2.maxAttempts < 1)
  ...
  }(Ph(t), (n2) => e(new Lf(t, n2)), s);
}
function Uf() {
  return new tl("deleteField");
}
function Kf() {
  return new nl("serverTimestamp");
}
function Gf(...t) {
  return new sl("arrayUnion", t);
}
function Qf(...t) {
  return new il("arrayRemove", t);
}
function jf(t) {
  return new rl("increment", t);
}
function zf(t) {
  return Ph(t = oh(t, Ah)), new Ff(t, (e) => Tf(t, e));
}
function Wf(t, e) {
  var n;
  const s = Ph(t = oh(t, Ah));
  ...
  const i = function(t2) {
    ...
    if (Array.isArray(e2.indexes))
      for (const t3 of e2.indexes) {
        const e3 = Hf(t3, "collectionGroup"), s2 = [];
        if (Array.isArray(t3.fields))
          for (const e4 of t3.fields) {
            const t4 = wl("setIndexConfiguration", Hf(e4, "fieldPath"));
            "CONTAINS" === e4.arrayConfig ? s2.push(new wt(
              t4,
              2
              /* IndexKind.CONTAINS */
            )) : "ASCENDING" === e4.order ? s2.push(new wt(
              t4,
              0
              /* IndexKind.ASCENDING */
            )) : "DESCENDING" === e4.order && s2.push(new wt(
              t4,
              1
...
!function(t, e = true) {
  !function(t2) {
    ...
    const i = t2.getProvider("app").getImmediate(), r2 = new Ah(new z2(t2.getProvider("auth-internal")), new Y2(t2.getProvider("app-check-internal")), function(t3, e2) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(b, "3.11.0", t), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(b, "3.11.0", "esm2017");
}();
export {
  zl as AbstractUserDataWriter,
  Bh as AggregateField,
  Lh as AggregateQuerySnapshot,
  qh as Bytes,
  Eh as CACHE_SIZE_UNLIMITED,
  dh as CollectionReference,
  lh as DocumentReference,
  nf as DocumentSnapshot,
  Uh as FieldPath,
  Gh as FieldValue,
  Ah as Firestore,
  U2 as FirestoreError,
  Qh as GeoPoint,
  Th as LoadBundleTask,
  fh as Query,
  bl as QueryCompositeFilterConstraint,
  Al as QueryConstraint,
  sf as QueryDocumentSnapshot,
  Fl as QueryEndAtConstraint,
  vl as QueryFieldFilterConstraint,
  xl as QueryLimitConstraint,
  Dl as QueryOrderByConstraint,
  rf as QuerySnapshot,
  Ml as QueryStartAtConstraint,
  ef as SnapshotMetadata,
  it as Timestamp,
  Lf as Transaction,
  Ff as WriteBatch,
  $e as _DatabaseId,
  ...
  M2 as _logWarn,
  nh as _validateIsNotUsedTogether,
  yf as addDoc,
  Zl as aggregateFieldEqual,
  tf as aggregateQuerySnapshotEqual,
  Sl as and,
  Qf as arrayRemove,
  Gf as arrayUnion,
  Yl as average,
  Ch as clearIndexedDbPersistence,
  _h as collection,
  wh as collectionGroup,
  hh as connectFirestoreEmulator,
  Xl as count,
  gf as deleteDoc,
  Uf as deleteField,
  kh as disableNetwork,
  mh as doc,
  Kh as documentId,
  Vh as enableIndexedDbPersistence,
  Sh as enableMultiTabIndexedDbPersistence,
  Nh as enableNetwork,
  Ll as endAt,
  Bl as endBefore,
  Ph as ensureFirestoreConfigured,
  Tf as executeWrite,
  Rf as getAggregateFromServer,
  Af as getCountFromServer,
  cf as getDoc,
  hf as getDocFromCache,
  lf as getDocFromServer,
  ff as getDocs,
  df as getDocsFromCache,
  ...
  kl as limitToLast,
  Oh as loadBundle,
  Sf as memoryEagerGarbageCollector,
  Cf as memoryLocalCache,
  Df as memoryLruGarbageCollector,
  $h as namedQuery,
  pf as onSnapshot,
  If as onSnapshotsInSync,
  Vl as or,
  Cl as orderBy,
  xf as persistentLocalCache,
  Of as persistentMultipleTabManager,
  Mf as persistentSingleTabManager,
  Rl as query,
  yh as queryEqual,
  gh as refEqual,
  qf as runTransaction,
  Kf as serverTimestamp,
  wf as setDoc,
  Wf as setIndexConfiguration,
  x2 as setLogLevel,
  uf as snapshotEqual,
  $l as startAfter,
  Ol as startAt,
